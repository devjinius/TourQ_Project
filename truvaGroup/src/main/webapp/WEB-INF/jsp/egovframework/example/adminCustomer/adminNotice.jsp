...
var jqgridTable = 
{
	...
	init : function() {
		...
		var cnames = ['번호','제목','조회수','등록일','버튼'];

	    $("#jqGrid").jqGrid({
	    	
	        url: "adminJqNotice.do",
	        datatype: "local",
	        colNames: cnames,
	        colModel:[
	   	   		   {name:'seq',       		index:'seq',       	width:55, key:true,    align:"center"},	
		           {name:'boardTitle',      index:'boardTitle', width:100, align:"center"},
		           {name:'count',      		index:'count',      width:100, align:"center"},
		           {name:'boardDate',     	index:'boardDate',  width:100, align:"center"},
		...
		<!-- Page heading -->
			...
			<div class="pull-right widget-head-right">
				<div class="bread-crumb">
				  ...
				  <a href="#" class="bread-current">공지사항</a>
				</div>
	...
	<div class="matter">
		<div class="col-md-12 widget-top">
			...
			<div class="pull-right">
				...
				<button class="btn btn-xs btn-green pull-left" type="button" onclick="javascript:left.adminSubmitFn('adminNoticeCreate','adminNoticeCreate.do','frmAdmin')">
