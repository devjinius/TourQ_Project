                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-big-title clearfix">
                            <div class="pull-left">
                                <h3>회원가입 약관 동의</h3>
                                <p>회원으로 가입하시면 TourQ에서 드리는 여러가지 쿠폰과 이벤트 등에 참여하실 수 있으며,
                                	<br />가입시 가입 축하금으로 3000원의 포인트가 적립됩니다.</p>
                            </div>
	         ...
	         <div class="container">
	             <div class="row">
	                 <div class="col-md-11 align-center">
	                 	<div class="col-sm-12">
					 		<h4 class="myPage-mini-title pd-top-40">- TourQ 회원가입 약관</h4>
		                     <div class="form-group agree-cmmn">
		                    	 <div class="form-control">제1장 총칙
 
제1조 (목적)
이 약관은 SK플래닛 주식회사(이하 "회사")가 운영하는 11번가(http://www.11st.co.kr 및 m.11st.co.kr, 이하 "11번가")에서 제공하는 전자상거래 관련 서비스(이하 "서비스")를 이용함에 있어 상품 또는 용역을 거래하는 자 간의 권리, 의무 등 기타 필요사항, 회원과 회사간의 권리, 의무, 책임사항 및 회원의 서비스 이용절차 등에 관한 사항을 규정함을 목적으로 합니다.
...
14. 캐시: 11번가에서 회원이 휴대전화 결제 등의 결제수단으로 결제한 후 상품 구매 취소 등의 사유로 환불을 요청했을 때 회사가 회원에게 결제 금액을 환불해야 하나, 그 결제수단의 특성상 같은 절차로 환불하기가 어려워 회사가 회원에게 환불해야 하는 현금 환불수단으로 활용되는 정보를 말합니다.
...
20. 분쟁조정센터: 11번가를 통한 거래에서 분쟁이 발생하면 판매자와 구매자가 자율적으로 해결하는 것이 원칙이지만, 분쟁의 합리적이고 원활한 조정을 위하여 예외적으로 회사가 설치·운영하는 분쟁조정기구를 말합니다.
...
제14조 (서비스 이용료)
① 회사는 11번가의 일부 특정 서비스나 기능을 제공할 때 이용료를 부과할 수 있습니다
...
③ 캐시는 회사가 운영하는 선불전자지급수단인 오케이캐쉬백포인트로 전환 가능하며, 최소 일천원(￦1,000원)부터 충전할 수 있고 11번가가 제공하는 결제수단 중 현금입금으로만 충전할 수 있습니다.
...
⑦ 본 조 제6항의 기한과 이용방법은 공지내용과 11번가 홈페이지에서 확인할 수 있습니다.
...
⑩ 11번가에서 회원이 휴대전화 결제 등의 결제수단으로 결제한 후 상품 구매 취소 등의 사유가 발생하면 회사가 회원에게 결제 금액을 환불해야 하나, 그 결제수단의 특성상 같은 절차로 환불하기가 어려우면 회사는 회원에게 환불수단으로 캐시를 이용하여 회원에게 환불해 줄 수 있습니다. 이 때, 캐시는 현금출금만 가능하며, 캐시 1원은 현금 1원의 의미가 있습니다.
...
④ 구매자는 구매자의 지인 및 일반 11번가 고객과의 1:1, 1:N 간 채팅을 위해 회사가 제공하는 메신저 서비스를 이용할 수 있습니다. 서비스를 이용하는 과정에서 구매자의 전화번호, 단말기 주소록 내에 저장된 연락처 정보(이름/전화번호), 11번가 회원가입 이름, MDN 정보를 수집합니다. 해당 서비스를 통한 대화 내용은 대화 당사자가 동시에 대화 진행 불가 시 대화 내용 유지 등 원활한 서비스 제공을 위해 최대 7일간 암호화되어 저장되었다가 자동으로 삭제되며 회사는 해당 서비스 이용 목적 외 이를 사용하지 않습니다.
...
⑪ 확인된 거래가 취소되어 결제대금을 환불할 경우는 회사는 거래가 취소된 날로부터 2영업일 이내에 구매자에게 환불에 필요한 조치를 합니다. 신용카드로 결제했을 때는 환불을 요청한 즉시 결제 승인이 취소되고, 11번가 선불전자지급수단으로 결제한 거래가 취소되었을 때에는 즉시 환불조치를 합니다.
...
⑩ 제3자에게 재판매하기 위한 목적으로 회사가 제공하는 혜택을 부당하게 이용하는 행위(다른 오픈마켓이나 인터넷쇼핑몰 등에 임의로 최저가를 등록하는 등으로 11번가 할인쿠폰 발행을 유도한 후 해당 쿠폰을 적용하여 구매하는 행위 등)는 금지되며, 재판매 목적의 거래행위가 확인된 경우 회사는 해당 회원에 대하여 서비스이용제한, 이용계약의 해지 등의 조치를 취할 수 있으며, 이러한 행위로 손해가 있을 경우 배상을 청구할 수 있습니다.
...
제1조 (시행일) 본 약관은 2017년 2월 3일부터 시행합니다.
	                 	...
	                 	<div class="col-sm-12">
		                     ...
		                     <div class="col-register agree-my-phone align-center">
			                     <div class="col-sm-8 agree-my-confirm align-center">
		                    		 <div class="agree-Check">
		                  			 	 <input type="radio" class="radio-btn" name="radio-btn" checked><p>핸드폰 인증</p>
		                 			 </div>
		                    		 <div class="agree-Check">
		                  			 	<input type="radio" class="radio-btn" name="radio-btn"><p>마이핀 인증</p> 
		                 			 </div>
			                     </div>
			                     <div class="col-sm-8 align-center">
			                         <form role="form" method="post">
			                             <div class="form-group col-sm-3">
			                                 ...
			                                 <input type="text" name="phone1" class="l-form-username form-control" id="phone1">
			                             </div>
			                             <div class="form-group col-sm-3">
			                                 <label class="sr-only" for="l-form-username">Username</label>
			                                 <input type="text" name="phone2" class="l-form-username form-control" id="phone2">
			                             </div>
			                             <div class="form-group col-sm-3">
			                                 <label class="sr-only" for="l-form-us	ername">Username</label>
			                                 <input type="text" name="phone3" class="l-form-username form-control" id="phone3">
			                             </div>
		                 ...
		                 <div class="col-sm-12 text-center pd-top-40">
		                     <button class="btn btn-primary radius btn-lg" type="button"onclick="javascript:nav.pageSubmitFn('memberJoin', 'frm')">회원가입하기</button>
		                 </div><!-- end col -->
