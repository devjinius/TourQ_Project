	...
	$.ajax({
		...
		success	: function(result){
			...
			if(result == "SUCCESS"){
				...
				alert("에러가 발생했습니다. ErrorCode : FaqCreate01");
			}
		}
	});
			...
			<div class="table-responsive">
				<table class="table table-bordered table-row">
				  <thead>
						<tr>
							<th>제목</th>
							<td class="ip-text" colspan="2"><input class="form-control" type="text" name="faqTitle" id="faqTitle"></td>
						</tr>
						<tr>
							<th>타입</th>
							<td colspan="2">
						...
						<tr>
							<th>내용</th>
							<td class="ip-text">
								<textarea id="faqContents" name="faqContents" class="textarea-box" style="height: 385px;"></textarea>
							</td>
						</tr>
				</thead>
				</table>
