                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-big-title clearfix">
                            <div class="pull-left">
                                <h3>비회원 구매약관 동의</h3>
                                <p>비회원으로 구매하시면 TourQ에서 드리는 모든 할인/쿠폰과 이벤트 등의 혜택을 받으실 수 없습니다.
                                	<br />또한 비회원 주문 시에는 적립금이 지급되지 않습니다.</p>
                            </div>
                        </div>
                    </div>
                </div>
	         ...
	         <div class="container">
	             <div class="row">
	                 <div class="col-md-11 align-center">
	                 	<div class="col-sm-12">
					 		<h4 class="myPage-mini-title pd-top-40">- TourQ 구매이용약관</h4>
		                     <div class="form-group agree-cmmn">
		                    	 <div class="form-control">제1장 총칙
 
제1조 (목적)
이 약관은 SK플래닛 주식회사(이하 "회사")가 운영하는 TourQ(http://www.11st.co.kr 및 m.11st.co.kr, 이하 "TourQ")에서 제공하는 전자상거래 관련 서비스(이하 "서비스")를 이용함에 있어 상품 또는 용역을 거래하는 자 간의 권리, 의무 등 기타 필요사항, 회원과 회사간의 권리, 의무, 책임사항 및 회원의 서비스 이용절차 등에 관한 사항을 규정함을 목적으로 합니다.
 
제2조 (용어의 정의)
① 이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
1. TourQ: 자유로운 상품 또는 용역(이하 "상품")의 거래를 위하여 회사가 제공하는 실시간 전자상거래 시스템과 그 운영을 위한 웹사이트를 말합니다.
...
가. 일반회원(구매고객): TourQ에서 상품구매 및 구매와 관련하여 제공되는 서비스를 이용할 수 있는 회원을 말합니다. 일반회원은 개인구매회원과 사업자구매회원으로 구분됩니다.
a. 개인구매회원: 구매만을 목적으로 하는 회원으로 만 14세 이상이면 누구나 가입할 수 있음(국내에 거주하는 외국인 포함)
b. 사업자구매회원: 구매를 목적으로 사업자 정보로 등록한 회원
나. 셀러회원(구매판매고객): TourQ에서 상품 구매 및 관련 서비스와 판매회원약관(이하 "판매이용약관")상의 서비스를 이용할 수 있는 회원을 말합니다. 셀러회원은 개인셀러회원과 사업자셀러회원으로 구분됩니다.
...
6. 비밀번호(Password): 회원 인지를 확인하고 비밀을 보호하기 위하여 회원이 스스로가 설정해 회사에 등록한 영문과 숫자의 조합을 말합니다.
...
12. 포인트: 회원이 렌탈 상품의 구매의사를 표현하여 상담사와의 상담을 요청하는데 사용하기 위한 전자적 정보로 회사가 해당 거래에 한하여 무상으로 지급합니다.
13. 마일리지: 회사에서 무상으로 지급하는 선불전자지급수단을 말합니다. 다만, 제16조 제8항에 따라 이용이 제한될 수 있습니다.
14. 캐시: TourQ에서 회원이 휴대전화 결제 등의 결제수단으로 결제한 후 상품 구매 취소 등의 사유로 환불을 요청했을 때 회사가 회원에게 결제 금액을 환불해야 하나, 그 결제수단의 특성상 같은 절차로 환불하기가 어려워 회사가 회원에게 환불해야 하는 현금 환불수단으로 활용되는 정보를 말합니다.
15. 구매확정기간: 구매자가 거래에 대하여 구매 종료(구매확정, 반품, 교환)의 의사표시를 해야 하는 기간으로, 물품수령일로부터 7일이 되는 날(설치상품 등 물품수령일을 확인할 수 없을 때에는 발송완료일로부터 15일이 지나 회사가 상품수령확인 요청을 한 날로부터 5일이 되는날)까지를 말합니다.
16. 본인확인: 휴대전화 인증(또는 i-PIN 인증)을 통하여 회원이 본인인지 여부를 확인하거나 사업자 회원의 상호와 사업자 등록번호의 일치 여부를 확인하고 제8조에서 정한 기재항목을 확인하는 것을 의미합니다.
17. 영업일: 회사가 정상적으로 서비스를 제공한 날로서 토요일, 일요일 및 법정 공휴일을 제외한 날을 말합니다.
18. 결제대금 보호서비스: 회사가 구매자가 결제한 결제대금을 보호하기 위하여 일정
기간 결제대금을 예치하는 서비스를 말합니다.
19. 안전거래센터: 서비스 이용 중 거래의 안전과 관련하여 발생할 수 있는 문제를 조정하기 위한 기구를 말합니다.
20. 분쟁조정센터: TourQ를 통한 거래에서 분쟁이 발생하면 판매자와 구매자가 자율적으로 해결하는 것이 원칙이지만, 분쟁의 합리적이고 원활한 조정을 위하여 예외적으로 회사가 설치·운영하는 분쟁조정기구를 말합니다.
② 제1항에서 정의되지 않은 용어의 의미는 관련 법령 및 일반적인 거래관행을 따릅니다.
 
제3조 (적용 범위 및 효력 우선순위)
① 이 약관에서 제1장(총칙), 제3장(기타사항)은 전체 서비스에 적용되며, 제2장은 TourQ(통신판매중개) 서비스에 구분하여 적용됩니다.
...
② 회사는 필요하면 특정 서비스에 적용될 사항(이하 “개별약관”)을 정하여 이를 TourQ 등을 통하여 공지할 수 있습니다.
③ 회사는 필요하면 서비스 이용과 관련된 세부적인 내용(이하 "이용정책")을 정하여 이를 TourQ 등을 통하여 공지할 수 있습니다.
④ 개별약관이나 이용정책의 변경이 있으면 회사는 변경 내용의 효력발생일 7일 이전에 TourQ를 통하여 해당 변경 사항을 공지합니다.
...
⑥ TourQ에서 제공하는 서비스를 통하여 거래가 성사 되었을 때 회사는 판매자와 구매자 간에 물품거래와 배송 등의 이행과 관련하여 필요한 범위 내에서 구매자의 개인정보를 판매자에게 제공합니다.
...
8. TourQ 구매/판매이용약관의 적용을 받는 자가 해당 약관을 위반한 경우
...
3. 회원의 의사로 해지한 후 회원 재가입, 임의 해지 등을 반복적으로 행하여 회사가 제공하는 각종 할인쿠폰, 이벤트 혜택 등 경제적 이익을 편법으로 수취하거나 이 과정에서 명의를 무단으로 사용하는 등 편법과 불법행위를 하는 것을 차단하고자 회사는 회원에게 회원 탈퇴한 날로부터 1개월(탈퇴시 회원이 판매회원의 지위도 동시에 가진 상태인 경우에는 2개월)이 지나야 재가입 할 수 있게 하고 있으며 회원은 이 약관이 정하는 회원가입절차와 관련 조항에 따라 회사에 통지된 재이용 의사를 회사로부터 승낙 받은 이후에 서비스를 재이용할 수 있습니다.
...
마. 회원이 이 약관에 위배되는 행위를 하거나 이 약관에서 정한 해지사유가 발생한 경우(TourQ 판매회원 약관의 적용을 받는 자가 해당 약관을 위반한 경우 포함)
...
제13조 (서비스 기간과 중단)
① 회원의 서비스 기간은 TourQ에 서비스를 신청하여 이용승낙을 받은 날로부터 서비스 이용계약을 해지할 때까지 입니다.
...
제14조 (서비스 이용료)
① 회사는 TourQ의 일부 특정 서비스나 기능을 제공할 때 이용료를 부과할 수 있습니다
② 회사가 제공하는 “SMS검색 서비스”(이용자가 휴대전화에서 원하는 키워드를 입력하고 지정된 번호로 문자를 전송하면, 검색결과를 자동으로 생성하여 Callback URL을 전송해주며, 이용자가 검색결과 값을 가진 Callback URL을 전송받아 간편하고 신속하게 해당 상품페이지 목록으로 접속할 수 있게 하는 기능임)를 이용할 때에는 문자메시지(SMS) 이용요금과 소정의 서비스 이용료가 부과됩니다.
...
제16조 (포인트, 마일리지, 캐시)
① 포인트는 회원이 렌탈 상품의 구매의사를 표현하여 상담사와의 상담을 요청하는데 사용하기 위한 전자적 정보로 이를 이용해 주문결제, 대금지급, 현금출금을 할 수 없습니다.
② 마일리지는 TourQ에서 사용되는 지불수단으로 이를 이용해 주문결제, 대금지급을 할 수 있으며, 1마일리지는 1원의 의미가 있습니다.
③ 캐시는 회사가 운영하는 선불전자지급수단인 오케이캐쉬백포인트로 전환 가능하며, 최소 일천원(￦1,000원)부터 충전할 수 있고 TourQ가 제공하는 결제수단 중 현금입금으로만 충전할 수 있습니다.
④ 마일리지는 전자금융거래법에 따라 그 합계가 최대 200만 원을 초과하여 충전 및 적립되지 않으며, 전자금융거래법 등 관계 법령에 따라 그 충전 한도가 달라질 수 있습니다.
⑤ 마일리지는 소진일 30일 전에 소멸 예정 사실을 회원에게 이메일(E-mail) 등으로 통지합니다.
⑥ 회원이 상품 구매나 이벤트 등을 통하여 회사로부터 무상으로 제공받은 마일리지는 회사에서 정한 기간과 방법으로만 이용할 수 있습니다.
⑦ 본 조 제6항의 기한과 이용방법은 공지내용과 TourQ 홈페이지에서 확인할 수 있습니다.
⑧ 구매를 통해 적립된 마일리지는 해당 구매가 취소 되면 회사에 의해 환수될 수 있습니다.
⑨ 회원의 구매 취소 등의 사유가 발생하여 회사가 회원에게 이미 부여한 마일리지를 환수하고자 할 경우, 해당 마일리지 환수 시점에 해당 회원의 마일리지 잔액이 환수 마일리지보다 작으면 회사는 해당 회원에 대한 마일리지가 0보다 작은 마이너스 마일리지로 처리할 수 있으며, 회원은 자신의 마이너스 마일리지를 추가 상품 구매를 통한 마일리지 적립으로 만회할 수 있습니다.
⑩ TourQ에서 회원이 휴대전화 결제 등의 결제수단으로 결제한 후 상품 구매 취소 등의 사유가 발생하면 회사가 회원에게 결제 금액을 환불해야 하나, 그 결제수단의 특성상 같은 절차로 환불하기가 어려우면 회사는 회원에게 환불수단으로 캐시를 이용하여 회원에게 환불해 줄 수 있습니다. 이 때, 캐시는 현금출금만 가능하며, 캐시 1원은 현금 1원의 의미가 있습니다.
...
④ 본 조 제3항에 언급된 회사의 사용권은 TourQ 서비스를 운영하는 동안에만 확정적으로 유효합니다.
...
⑦ 이용자가 TourQ를 이용하여 얻은 정보를 회사의 승낙 없이 복제, 송신, 출판, 배포, 방송, 기타 방법으로 이용하거나 제3자에게 이용하게 할 때 그에 대한 책임은 이용자 본인에게 있습니다.
⑧ 회원은 TourQ 내에서 자신의 저작권이 침해되면 회사가 운영하는 신고센터 제도를 이용하여 자신의 정당한 권리를 보호받을 수 있습니다.
...
5. 기타 제1호 내지 제4호에 준하는 중대한 사유로 말미암아 회사가 제공하는 TourQ 서비스의 원활한 진행을 방해하는 것으로 판단되는 경우
⑩ 회사가 제9항에 따라 게시물을 삭제했을 때, 해당 게시자는 회사에 이의를 제기하여 구제받을 수 있습니다.
 
제2장 TourQ(통신판매중개) 서비스
...
② 회사는 TourQ를 통하여 이루어지는 구매자와 판매자 간의 거래와 관련하여 판매의사 또는 구매의사의 존부 및 진정성, 등록 상품의 품질, 완전성, 안정성, 적법성 및 타인의 권리에 대한 비침해성, 구매자 또는 판매자가 입력하는 정보 및 그 정보를 통하여 링크된 URL에 게재된 자료의 진실성 또는 적법성 등 일체를 보증하지 않습니다. 다만, 등록된 상품 관련 정보가 법규 위반이나 저작권 침해가 명백한 경우, 또는 저작권 등 권리를 침해받았다고 주장하는 자가 그 침해의 정지ㆍ예방을 요청하는 경우 회사는 당사자간의 분쟁이 해결되어 권리관계가 명확해질 때까지 해당 상품에 대한 삭제, 수정 또는 미노출 처리할 수 있습니다.
...
④ 구매자는 구매자의 지인 및 일반 TourQ 고객과의 1:1, 1:N 간 채팅을 위해 회사가 제공하는 메신저 서비스를 이용할 수 있습니다. 서비스를 이용하는 과정에서 구매자의 전화번호, 단말기 주소록 내에 저장된 연락처 정보(이름/전화번호), TourQ 회원가입 이름, MDN 정보를 수집합니다. 해당 서비스를 통한 대화 내용은 대화 당사자가 동시에 대화 진행 불가 시 대화 내용 유지 등 원활한 서비스 제공을 위해 최대 7일간 암호화되어 저장되었다가 자동으로 삭제되며 회사는 해당 서비스 이용 목적 외 이를 사용하지 않습니다.
...
⑭ 회사가 구매자의 서비스 이용 편의를 높이기 위해 제휴업체로부터 정보를 제공받아 게재하거나 제3자가 제공하는 방식으로 TourQ 사이트 내 또는 링크 방식으로 참조용 정보나 콘텐츠를 제공할 수 있으며, 구매자는 상품 구매 때 자신의 판단과 책임으로 결정하여 구매하여야 합니다.
...
② 결제대금 보호 서비스는 TourQ에서 구매하는 모든 상품에 적용 됩니다.
...
⑪ 확인된 거래가 취소되어 결제대금을 환불할 경우는 회사는 거래가 취소된 날로부터 2영업일 이내에 구매자에게 환불에 필요한 조치를 합니다. 신용카드로 결제했을 때는 환불을 요청한 즉시 결제 승인이 취소되고, TourQ 선불전자지급수단으로 결제한 거래가 취소되었을 때에는 즉시 환불조치를 합니다.
...
⑩ 제3자에게 재판매하기 위한 목적으로 회사가 제공하는 혜택을 부당하게 이용하는 행위(다른 오픈마켓이나 인터넷쇼핑몰 등에 임의로 최저가를 등록하는 등으로 TourQ 할인쿠폰 발행을 유도한 후 해당 쿠폰을 적용하여 구매하는 행위 등)는 금지되며, 재판매 목적의 거래행위가 확인된 경우 회사는 해당 회원에 대하여 서비스이용제한, 이용계약의 해지 등의 조치를 취할 수 있으며, 이러한 행위로 손해가 있을 경우 배상을 청구할 수 있습니다.
...
제28조 (해외쇼핑 TourQ 특약)
① 회사는 해외 상품 수입 판매 또는 수입대행자(개인/사업자 포함), 해외사업자(개인/사업자 포함) 중 회사가 정한 절차에 따라 판매자로 가입된 자(이하 “글로벌셀러”)가 해외 브랜드 상품을 등록하고, 구매자가 글로벌셀러로부터 주문한 상품을 해외 또는 국내에서 배송/수취할 수 있는 해외쇼핑 서비스를 제공합니다.
② 해외쇼핑 TourQ 내에서의 판매자는 글로벌 셀러에 한정합니다.
...
⑥ 해외쇼핑 TourQ에서 판매되는 상품 가격에는 관세와 부가세(이하 ’관부가세’)가 포함되어 있을 수 있으며, 관부가세가 포함되어 있지 않은 상품에도, 상품 종류, 가액, 구매 목적(국내 판매 목적 구매 등) 등에 따라 추후 관부가세가 부과될 수 있으며, 이와 관련하여 관세청으로부터 수입신고 절차 및 관부가세 납부 절차의 통지를 받으실 수 있습니다.
⑦ 수입대행자인 글로벌셀러가 관세법에 따라 제6항의 수입신고를 대행하는 경우 관세법 등 관련 법령에 따라 회사는 글로벌셀러가 수입을 대행하는 데 필요한 구매자의 통관정보를 글로벌셀러로부터 위탁 받아 수집할 수 있습니다.
⑧ 본 조에서 달리 규정된 사항을 제외하고는, 해외쇼핑 TourQ를 이용하는 데도 이 약관의 제반 내용이 동일하게 적용됩니다.
...
② 전세계 배송의 경우, 구매자가 단순 변심으로 교환/반품을 요청했을 때 교환/반품으로 발생하는 비용(왕복 국내배송비 및 해외배송비 등)은 구매자가 부담해야 합니다.(단, 주문한 전 상품이 물류센터에 입고되어 합포장이 완료된 이후에는 고객센터를 통해 요청해야 합니다) 또한, 상품에 하자가 있거나 잘못된 상품이 배송되었을 때에는 수취확인 후 고객센터를 통해 관련 증빙자료를 제출해 주셔야 반품/교환 접수가 가능합니다. 접수 후 상품을 발송할 때에는 해외배송망(특송사 및 운송장번호 등)에 대한 정보를 고객센터를 통해 알려주셔야 합니다.
③ 전세계배송 서비스를 이용하여 상품을 구매했을 때, 주문 시 결제한 예상 해외배송비보다 실제 무게로 책정된 해외배송비가 적으면 회원이 결제했던 방법으로 환급됩니다. 예상 해외배송비보다 실제 무게로 책정된 해외배송비가 크면 추가 해외배송비를 결제해 주셔야 합니다.(단, 1천원 미만이면 결제하지 않아도 됨) 추가 해외배송비를 14일 이상 결제하지 않으면 주문하신 상품은 판매자에게 자동으로 반품되며, 이 때 국내 반품에 드는 비용을 결제해 주셔야 구매금액이 환불됩니다.
...
⑥ 해외 통관 거부, 주소지 불명, 수취인 거부에 따른 반송은 구매자 귀책으로 간주하며, 이 때문에 발생하는 국내/해외 배송비는 구매자가 부담합니다. 또한, 반송되는 상품은 회사의 물류센터에서 최대 90일까지만 보관하며, 90일간 구매자와 연락이 되지 않으면 상품은 폐기합니다. 해외 통관 때 압수, 폐기된 상품에 대해서는 재배송과 환불이 불가합니다.
...
제31조 (기타 조항)
① 회사는 필요하면 특정 서비스나 기능의 전부 또는 일부를 TourQ 사이트를 통해 미리 공지한 후 일시적 또는 영구적으로 수정하거나 중단할 수 있습니다.
② 각 당사자는 상대방의 서면 동의 없이 이 약관상의 권리와 의무를 제3자에게 양도하거나 처분할 수 없습니다.
③ 이 약관과 관련하여 당사자 간의 합의에 따라 추가로 작성된 계약서, 협정서, 통보서 등과 회사의 정책변경, 법령의 제·개정 또는 공공기관의 고시나 지침 등에 따라 회사가 TourQ 사이트를 통해 공지하는 내용도 이용계약의 일부를 구성합니다.
...
■ 부칙
제1조 (시행일) 이 약관은 2017년 7월 15일부터 시행합니다.
								 </div>
	                    		 <div class="agree-Check">
	                  			 	<input type="checkbox" class="checkBox"><p>이용 약관에 동의합니다.</p>
	                 			 </div>
		                     </div>
	                 	</div>
	                 	
	                 	<div class="col-sm-12">
					 		<h4 class="myPage-mini-title pd-top-40">- 전자금융거래 이용약관</h4>
		                     <div class="form-group agree-cmmn">
		                    	 <div class="form-control">제1장 총칙
 
제1조 (목적)
이 약관은 SK플래닛 주식회사(이하 ‘회사’)가 운영하는 인터넷 사이트(http://www.11st.co.kr; 이하 ‘TourQ’)를 통하여 제공하는 전자지급결제대행서비스, 결제대금예치서비스 및 선불전자지급수단(‘마일리지’)의 발행 및 관리 서비스(이하 통칭하여 ‘전자금융거래서비스’)를 이용자가 이용할 때 회사와 이용자 간 전자금융거래의 법률관계를 정하는 데 목적이 있습니다.
...
③ 회사가 본 약관을 변경하는 때에는 그 시행일 1개월 전에 변경되는 약관을 금융거래정보 입력화면과 회사의 홈페이지(‘TourQ’를 말합니다. 이하에서 같습니다)에 게시하여 이용자에게 공지합니다. 다만, 법령의 개정으로 인하여 긴급하게 약관을 변경한 때에는 변경된 약관을 홈페이지에 1개월 이상 게시하고 이용자에게 전자우편 등을 통하여 사후 통지합니다.
...
제4조 (거래내용의 확인)
① 회사는 ‘TourQ’의 ‘마이 페이지’ 조회 화면을 통하여 이용자의 거래내용(이용자의 ‘오류정정 요구사실 및 처리결과에 관한 사항’을 포함합니다)을 확인할 수 있도록 하며, 이용자가 요청하면 요청을 받은 날로부터 2주 이내에 모사전송, 우편 또는 직접 교부의 방법으로 거래내용에 관한 서면을 교부합니다. 다만, 전자적 장치의 운영장애, 그 밖의 사유로 거래내용을 제공할 수 없는 때에는 즉시 이용자에게 전자문서 전송(전자우편을 이용한 전송을 포함합니다)의 방법으로 그러한 사유를 알려야하며, 거래내용을 제공할 수 없는 기간은 서면교부 기간에 산입하지 아니합니다.
...
1. 주소: 경기도 성남시 분당구 판교로 264(삼평동)
2. 이메일(E-mail) 주소: customerservice@11st.co.kr
3. 전화번호: 1599-0110
 
제5조 (오류의 정정 등)
① 전자금융거래서비스를 이용하는 데 오류가 있음을 안 이용자는 회사에 그 정정을 요구할 수 있습니다.
② 회사는 제1항의 규정에 따른 오류의 정정요구를 받은때 또는 스스로 오류가 있음을 안 때에는 이를 즉시 조사하여 처리한 후 정정요구를 받은 날 또는 오류가 있음을 안 날부터 2주 이내에 그 결과를 문서, 전화 또는 전자우편으로 이용자에게 알려 드리며, 이용자가 문서로 알려줄 것을 요청하는 경우에는 문서로 알립니다.
 
제6조 (전자금융거래 기록의 생성 및 보존)
① 회사는 이용자가 이용한 전자금융거래의 내용을 추적, 검색하거나 그 내용에 오류가 발생했을 때 이를 확인하거나 정정할 수 있는 기록을 생성하여 보존합니다.
② 제1항의 규정에 따라 회사가 보존해야 하는 기록의 종류와 보존방법은 제4조 제2항, 제3항에서 정한 바를 따릅니다.
...
제9조 (회사의 책임)
① 회사는 접근매체의 위조나 변조로 발생한 사고, 계약체결 또는 거래지시의 전자적 전송이나 처리 과정에서 발생한 사고, 전자금융거래를 위한 전자적 장치 또는 '정보통신망 이용촉진 및 정보보호 등에 관한 법률' 제2조제1항제1호에 따른 정보통신망에 침입하여 거짓이나 그 밖의 부정한 방법으로 획득한 접근매체의 이용으로 발생한 사고로 이용자에게 손해가 발생했을 때 그 손해를 배상할 책임을 집니다.
...
③ 이용자는 회사의 분쟁처리결과에 이의가 있으면 ‘금융위원회의 설치 등에 관한 법률’ 제51조의 규정에 따른 금융감독원의 금융분쟁조정위원회나 ‘소비자기본법’ 제31조 제1항의 규정에 따른 한국소비자원의 소비자분쟁조정위원회에 회사의 전자금융거래서비스 이용과 관련한 분쟁조정을 신청할 수 있습니다.
 
제11조 (회사의 안정성 확보 의무)
회사는 전자금융거래가 안전하게 처리될 수 있도록 선량한 관리자로서의 주의를 다하며 전자금융거래의 안전성과 신뢰성을 확보할 수 있도록 전자금융거래의 종류별로 전자적 전송이나 처리를 위한 인력, 시설, 전자적 장치 등의 정보기술부문 및 전자금융업무에 관하여 금융위원회가 정하는 기준을 지킵니다.
...
제17조 (정의)
본 장에서 정하는 용어의 정의는 다음과 같습니다.
1. ‘결제대금예치서비스’는 ‘TourQ’에서 이루어지는 선불식 통신판매에서 회사가 소비자가 지급하는 결제대금을 예치하고 배송이 완료된 후 재화 등의 대금을 판매자에게 지급하는 제도를 말합니다.
...
4. ‘소비자’란 본 약관에 동의하고 회사 운영의 사이트에 입점한 판매자로부터 재화 등을 구매하는 자로서 ’전자상거래 등에서의 소비자보호에 관한 법률’ 제2조 제5호의 요건에 해당하는 자를 말합니다.
5. ‘이용자’란 ‘판매자’와 ‘소비자’를 말합니다.
 
제18조 (적용범위)
본 장은 이용자가 ‘TourQ’를 통한 선불식 통신판매를 이용하는 경우에 적용됩니다.
...
③ 소비자가 재화 등을 공급받은 날로부터 3영업일이 지나도록 정당한 사유의 제시 없이 그 공급받은 사실을 회사에 통보하지 않으면 회사는 소비자의 동의 없이 판매자에게 결제대금을 지급할 수 있습니다.
...
제22조 (정의)
본 장에서 정하는 용어의 정의는 다음과 같습니다.
1. 선불전자지급수단은 ‘마일리지’와 같이 재화 등을 구매하고 그 대가를 지급하는 데 사용하기 위하여 회사가 미리 이용자에게 공지하고 발행한 결제수단으로, 전자금융거래법에서 규정하는 것을 말합니다.
2. ‘마일리지’는 회사에서 무상으로 지급하는 선불전자지급수단을 말합니다. 다만, 제25조의2에 따라 이용이 제한될 수 있습니다.
3. ‘이용자’란 본 약관에 동의하고 판매자로부터 재화 등을 구매하고 ‘마일리지’를 결제수단으로 하여 그 대가를 지급하는 자를 말합니다.
4. ‘판매자’란 이용자에게 재화 등을 판매하고 ‘마일리지’를 결제수단으로 하여 그 대가를 지급받는 자를 말합니다.
5. 본 장에서 ‘접근매체’란 ‘마일리지’를 이용한 전자금융거래에서 지급지시를 하거나 이용자 및 거래내용의 진실성과 정확성을 확보하기 위하여 회사에 등록된 이용자번호, 비밀번호, 기타 회사가 지정한 수단을 말합니다.
 
제23조 (접근매체의 관리)
① 회사는 이용자로부터 ‘마일리지’나 접근매체의 분실 또는 도난 등의 통지를 받기 전에 발생한 저장된 금액에 대한 손해에 대해서는 책임지지 않습니다.
② 제2장 결제대행서비스 제16조 제1항 내지 제3항은 본장 선불 전자지급수단(‘마일리지’)에 준용합니다.
 
제24조 (환급 등)
① 이용자가 상품 구매나 이벤트 등을 통하여 회사로부터 무상으로 제공받은 ’마일리지’는 환급되지 않습니다.
② 이용자가 상품 구매나 이벤트 등을 통하여 회사로부터 무상으로 제공받은 ‘마일리지’는 회사에서 정한 기한과 이용방법에 한해서만 이용할 수 있으며, 기한과 이용방법은 ‘마일리지’가 발행되었을 때의 공지내용과 홈페이지 내 ‘나의 TourQ’, ‘고객센터’에서 확인할 수 있습니다.
 
제25조 (마일리지 환수 및 마이너스 마일리지 처리)
① 구매를 통해 적립된 이용자의 ‘마일리지’는 해당 구매가 취소되면 회사에 의해 환수될 수 있습니다.
② 이용자에게 구매 취소 등의 사유가 발생하여 회사가 이용자에게 이미 부여한 ‘마일리지’를 환수하고자 할 때 해당 ‘마일리지’ 환수 시점에 이용자의 ‘마일리지’ 잔액이 환수 ‘마일리지’보다 적으면 회사는 해당 이용자에 대한 ‘마일리지’를 0보다 작은 마이너스 마일리지로 처리할 수 있으며, 이용자는 자신의 마이너스 마일리지를 이용자의 추가 구매를 통한 ‘마일리지’ 적립 등으로 만회할 수 있습니다.
 
제25조의2 (이용제한)
‘마일리지’는 순금, 상품권 등 불법적인 현금화 우려가 있는 일부 상품의 구매에는 이용이 제한될 수 있으며, ‘마일리지’는 제24조 제2항에서 규정한 이용방법에 따라 이용이 제한될 수 있습니다.
 
제26조 (거래지시의 철회)
① 선불전자지급수단을 이용한 이용자는 거래 지시된 금액의 정보가 수취인이 지정한 전자적 장치에 도달한 때까지 거래지시를 철회할 수 있습니다.
② 이용자의 거래지시 철회에 따라 지급거래가 이루어지지 않으면 회사는 수령한 자금을 이용자에게 반환해야 합니다.
 
제27조 (준용규정)
제2장 결제대행서비스 제16조는 본 장 선불전자지급수단에 준용합니다.
 
부칙
제1조 (시행일) 본 약관은 2017년 2월 3일부터 시행합니다.
								 </div>
	                    		 <div class="agree-Check">
	                  			 	<input type="checkbox" class="checkBox"><p>이용 약관에 동의합니다.</p>
	                 			 </div>
	                 	...
	                 	<div class="col-sm-12">
					 		<h4 class="myPage-mini-title pd-top-40">- 개인정보 수집 및 이용에 대한 안내</h4>
		                     <div class="form-group agree-cmmn">
		                    	 <div class="form-control">비회원 개인정보 수집/이용 약관
비회원으로 서비스를 이용하는 경우, 수집/이용하는 개인정보는 다음과 같습니다.
고객님께서는 동의를 거부할 권리가 있으며, 동의 거부 시 TourQ 서비스 이용이 불가합니다.
개인정보 수집 및 이용 목적	수집하는 개인정보 항목	개인정보의 보유 및 이용기간
본인인증 기관을 통한 본인확인 및 식별, 연령제한 서비스 이용제공	성명, 휴대전화번호, CI(연계정보), DI(중복정보), 생년월일, 성별	고객님의 개인정보는 서비스를 제공하는 기간 동안 보유 및 이용하며, 개인정보의 수집 및 이용목적이 달성되면 지체없이 파기합니다. 다만, 관계법령의 규정 및 내부지침에 의하여 고객님의 개인정보를 보관할 필요성이 있는 경우에는 아래와 같이 고객님의 개인정보를 보관할 수 있으며, 이 경우 해당 개인정보는 보관의 목적으로만 이용합니다.
...
서비스 이용에 따른 민원사항의 처리, 본인의사의 확인, 새로운 정보와 고지사항의 안내	성명, 휴대전화번호, 이메일주소(e-mail), 서비스이용정보(고객이 서비스를 이용하는 과정에서 생성된 서비스이용기록, 요금청구 및 결제기록, 접속기록, 쿠키, 접속IP정보)
상품 및 경품배송(반품/환불/최소 등)을 위한 배송주소 및 연락처 확인	성명, 주소, 휴대전화번호, 이메일주소(e-mail), 수취인정보(수취인명, 배송지주소, 휴대전화번호, 전화번호)
대금결제서비스의 제공	계좌정보, 신용카드정보
불량회원의 부정 이용방지, 전자금융거래기록보관	IP address, 방문일시
부정거래방지	성명, 주소, 휴대전화번호, 이메일주소(e-mail), 접속IP, 수취인정보, 결제기록

비회원으로 서비스를 이용하는 경우 회원에게만 적용되는 사항을 제외한 나머지 부분에 대해서는 TourQ 회원과 동일한 개인정보취급방침이 적용됩니다.
		                    	 </div>
	                    		 <div class="agree-Check">
	                  			 	<input type="checkbox" class="checkBox"><p>이용 약관에 동의합니다.</p>
	                 			 </div>
	                 	...
	                 	<div class="col-sm-12">
					 		<h4 class="myPage-mini-title pd-top-40">- 본인인증</h4>
		                     <div class="col-register agree-my-phone align-center">
			                     <div class="col-sm-8 agree-my-confirm align-center">
		                    		 <div class="agree-Check">
		                  			 	<input type="radio" class="radio-btn"><p>핸드폰 인증</p>
		                 			 </div>
		                    		 <div class="agree-Check">
		                  			 	<input type="radio" class="radio-btn"><p>마이핀 인증</p>
		                 			 </div>
			                     </div>
			                     <div class="col-sm-8 align-center">
			                         <form role="form" method="post">
			                             <div class="form-group col-sm-3">
			                                 ...
			                                 <input type="text" name="l-form-username" class="l-form-username form-control" id="l-form-username">
			                             </div>
			                             <div class="form-group col-sm-3">
			                                 <label class="sr-only" for="l-form-username">Username</label>
			                                 <input type="text" name="l-form-username" class="l-form-username form-control" id="l-form-username">
			                             ...
			                             <div class="form-group col-sm-3">
			                                 <label class="sr-only" for="l-form-us	ername">Username</label>
			                                 <input type="text" name="l-form-username" class="l-form-username form-control" id="l-form-username">
			                             </div>
			                             <button class="btn btn-primary" type="button">본인 인증하기</button>
			                         </form>
			                     </div>
		                     </div>
	                 	</div>
		                 <div class="col-sm-12 text-center pd-top-50">
		                     <button id="nMemberReservationBtn" class="btn btn-primary radius btn-lg" type="button" onclick="javascript:nav.pageSubmitFn({pageName: 'nMemberReservation', frmName: 'frm', url: 'nMemberReservation.do'})">비회원 예약하기</button>
		                 </div><!-- end col -->
