...
var changePay = {
	...
	payCoupon	: function(discount){
		...
		$finalPrice.text(this.finalPrice - couponDiscount);
	}
}
                                       	  ...
                                       	  <input type="hidden" order="info" 	name="productNumber"	id="productNumber">
                               			 	<div class="row">
	                                             <div class="col-md-6">
	                                                 ...
	                                                 <input type="text" class="form-control" order="info" name="orderName" id="orderName" placeholder="이름">
	                                                 </div>
	                                             </div>
	                                             <div class="col-md-6">
	                                                 <div class="form-group">
	                                             ...
	                                             <div class="col-md-12">
	                                                 <div class="form-group">
	                                                 <input type="email" class="form-control" order="info" name="orderEmail" id="orderEmail" placeholder="E-mail">
	                                                 </div>
	                                             </div>
	                                             ...
	                                             <div class="col-md-2">
	                                                 <div class="form-group">
	                                                 <input type="number" class="form-control" order="info" name="resCount" id="resCount" placeholder="예약인원">
	                                                 </div>
	                                             </div>
	                                             <div class="col-md-7">
	                                                 <div class="form-group">
	                                             ...
	                                             <div class="col-md-12">
		                                             ...
		                                             <div class="col-md-6 comment-input-area align-right">
		                                                 <div class="comment-input col-sm-12">보유 적립금  : <span>비회원 입니다.</span></div>
		                                             </div>
